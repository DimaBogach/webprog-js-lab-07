// Стрілочна функція для сортування користувачів за кількістю друзів у спадному порядку
const sortByDescendingFriendCount = (users) => users.sort((a, b) => b.friends.length - a.friends.length);

// Масив об'єктів користувачів для перевірки функції
...
console.log(sortByDescendingFriendCount(usersForSorting));
